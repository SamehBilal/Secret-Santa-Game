...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* background-image: url("https://s3-us-west-2.amazonaws.com/s.cdpn.io/74321/bacon-red.svg"); */
...
<body>
    ...
    <path fill="#0A0A0A" d="M408.424,259.126c-6.145,0.44-11.873,2.104-17.349,4.458c1.873-7.48,7.205-30.873-6.877-29.254
        ...
        <div class="card-page cart-page-bottom">
          <p>Your secret santa is:<br><br><span id="span" style="color: #a61715">{{ $user->full_name }} <br>  <small style="color: #000">{{ $user->category }}</small></span>
