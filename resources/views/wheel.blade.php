...
<body>
    ...
    <button class="button on-button right-top" onclick="spin();">ON</button>
    ...
    <script>
        ...
        var prizes = [
            @foreach ($users as $item)
                ...
                @endif
            @endforeach
            /*"Rs. 1000 in PB 1", "Multiplier Ticket 1", "Stackup Ticket 1",
        ...
        function spin() {
            ...
            spinTime = 0;
            spinTimeTotal = 4000;
            console.log('spinAngleStart =>', spinAngleStart, 'spinTime start =>', spinTime, 'spinTimeTotal =>',
                spinTimeTotal);
            rotateWheel();
        }
        ...
        function rotateWheel() {
            ...
            console.log('spinAngleStart =>', spinAngleStart, 'spinTime =>', spinTime, 'spinTimeTotal =>', spinTimeTotal,
                'spinAngle =>', spinAngle, 'startAngle =>', startAngle);
            drawRouletteWheel();
