    ...
    <main class="wrapper">
        ...
        <form method="POST" action="{{ route('dashboard.profile', $user->id) }}" enctype="multipart/form-data">
            ...
            <div class="dropdown">
                ...
                <input type="text" name="nickname" id="monster-select" value="{{ $user->full_name }}"
                    autocomplete="off">
                ...
                <select name="category" id="category">
                    <option value="Food and Drinks" {{ $user->category == 'Food and Drinks' ? 'selected' : '' }}>Food and
                        Drinks</option>
                    ...
                    <option value="Sports and Outdoors" {{ $user->category == 'Sports and Outdoors' ? 'selected' : '' }}>
                    ...
                    <option value="Subscription Services"
                        {{ $user->category == 'Subscription Services' ? 'selected' : '' }}>Subscription Services</option>
                </select>
